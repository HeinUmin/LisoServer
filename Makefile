...
# all binaries
BIN := example echo_server echo_client liso_server
# C compiler
CC  := gcc
# C PreProcessor Flag
CPPFLAGS := -Iinclude
...
default: all
all : example echo_server echo_client liso_server
...
liso_server: $(OBJ_DIR)/liso_server.o $(OBJ_PUBLIC)
	$(CC) -Werror $^ -o $@
